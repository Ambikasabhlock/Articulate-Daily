...
if(process.argv[1]===fileURLToPath(import.meta.url)){const server=createServer();server.listen(8080,"127.0.0.1",()=>console.log("Articulate Daily: http://127.0.0.1:8080"));}
